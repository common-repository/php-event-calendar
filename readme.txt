...
* Switch to the PHPMailer library included in WordPress
* Updated ADOdb library

= 1.5.9 =
* Changed how files are referenced work with all setups of WordPress including sub-directory setup
* Use WordPress current version of jQuery files
* Introduced "pec" function name prefix to avoid potential naming collison
* Remove DEBUG flag for error reporting

= 1.5.8 =
* Import security fix. Replace Uploadify with jQuery File Upload
